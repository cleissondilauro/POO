...
public class Data implements Serializable{
	...
	/**
	 * @param _dia inteiro que representa o dia 
	 * @param _mes inteiro que representa o mês 
	 * @param _ano inteiro que representa o ano 
	 */
	 ...
	 * @param ano inteiro
	 * @return true para ano bissexto <p>
	 * false para um ano que não seja bissexto
	 */
	 ...
	 * @return true para data Válida <p> 
	 * false para data Inválida   
	 */
	 ...
	 * Sobreposição do método toString para retornar todo o conteúdo da coleção
	 * separando os elementos por espaços
	 * @return retorna um boolean true se objetos forem iguais <p> false para diferentes
	 */
	...
	/**
	 * Compara duas instancias da classe Data
